package com.example.swipebacklayout.view;
...
public class SwipeBackLayout extends FrameLayout {
    ...
    /**
     * 可以跟踪的触摸边界。这里设置默认为ViewDragHelper中的值
     * 分为上，下，左，右
     */
     ...
     * callback's
     * {@link ViewDragCallback#onEdgeTouched(int, int)}
     * and
     * {@link ViewDragCallback#onEdgeDragStarted(int, int)}
